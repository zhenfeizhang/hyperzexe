...
pub struct HyperPlonkProof<C, PC, PCS>
where
    C: AffineCurve,
    PC: PermutationCheck<C, PCS>,
    PCS: PolynomialCommitmentScheme<C, Polynomial = Arc<DenseMultilinearExtension<C::ScalarField>>>,
{
    ...
    pub zero_check_proof: <PC as ZeroCheck<C::ScalarField>>::ZeroCheckProof,
...
pub struct HyperPlonkProvingKey<C: AffineCurve, PCS: PolynomialCommitmentScheme<C>> {
    /// Hyperplonk instance parameters
    pub params: HyperPlonkParams,
    /// The preprocessed permutation polynomials
    pub permutation_oracles: Vec<Arc<DenseMultilinearExtension<C::ScalarField>>>,
    /// The preprocessed selector polynomials
    pub selector_oracles: Vec<Arc<DenseMultilinearExtension<C::ScalarField>>>,
...
///   - the parameters for polynomial commitment
#[derive(Clone, Debug, Default, PartialEq)]
pub struct HyperPlonkVerifyingKey<C: AffineCurve, PCS: PolynomialCommitmentScheme<C>> {
    /// Hyperplonk instance parameters
    pub params: HyperPlonkParams,
    /// The parameters for PCS commitment
