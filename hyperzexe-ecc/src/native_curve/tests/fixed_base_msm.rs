...
use super::*;
use halo2_base::{
    halo2_proofs::{group::Curve, halo2curves::bn256::G1},
    SKIP_FIRST_PASS,
};
    ...
    fn synthesize(
        ...
        layouter.assign_region(
            ...
            |region| {
                ...
                // ecc_chip.fixed_base_scalar_mult(ctx, &FixedEcPoint::<Fr,
                // G1Affine>::from_g1(base, config.fp_chip.num_limbs, config.fp_chip.limb_bits),
                // scalar, Fr::NUM_BITS as usize, 4)).collect::<Vec<_>>();
